    ...
    <div className={styles.container}>
      ...
      <table className={styles.table}>
        ...
        <tbody>
          ...
          <tr><td>Height</td><td>&mdash;</td><td>Average height is 1.5 meters (5 ft), optimized for subterranean and interior spaces.</td></tr>
      ...
      {/* Continue escaping special characters in the rest of the sections */}
    </div>
  );
}